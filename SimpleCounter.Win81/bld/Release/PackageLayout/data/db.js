...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(SimpleCounter.config.endpoints);

    var serviceConfig = $.extend(true, {}, SimpleCounter.config.services, {
        db: {
    ...
    SimpleCounter.db = new DevExpress.data.ODataContext(serviceConfig.db);
